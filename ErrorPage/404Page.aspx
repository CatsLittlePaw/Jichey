<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="404Page.aspx.cs" Inherits="Jichey.ErrorPage._404Page" %>
    ...
    <div class="kt-grid kt-grid--ver kt-grid--root">
        <div class="kt-error404-v1">
            <div class="kt-error404-v1__content">
                <div class="kt-error404-v1__title" style="text-align: center;">404</div>
                <div class="kt-error404-v1__desc"><strong>OOPS!</strong> 網頁發生錯誤，請聯絡工程師</div>
            </div>
            <div class="kt-error404-v1__image">
                <%--<img src="lib/keen/assets/media/misc/404-bg1.jpg" class="kt-error404-v1__image-content" alt="" title="" />--%>
                <img src="/Images/404.jpg" class="kt-error404-v1__image-content" alt="" title="" />
            </div>
        </div>
    </div>
    <!-- end:: Page -->
