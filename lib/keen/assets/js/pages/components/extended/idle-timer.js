"use strict";
var KTIdleTimerJichey = function() {
    ...
    var Jichey1 = function() {
        ...
        */
        ...
        $("#btInit").click(function() {
            // for Jichey purposes show init with just object
            $(document).idleTimer({
                timeout: docTimeout
            });
            $('#docStatus')
        ...
        //For Jichey purposes, style based on initial state
        if ($(document).idleTimer("isIdle")) {
            $("#docStatus")
                .val(function(i, v) {
        ...
        //For Jichey purposes, display the actual timeout on the page
    ...
    var Jichey2 = function() {
        ...
        */
        ...
        //For Jichey purposes, show initial state
        if ($("#elStatus").idleTimer("isIdle")) {
            $("#elStatus")
                .val(function(i, v) {
