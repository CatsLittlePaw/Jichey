...
var KTDatatableChildRemoteDataJichey = function () {
    // Private functions
    ...
    var Jichey = function () {
        ...
        var datatable = $('.kt_datatable').KTDatatable({
            ...
            data: {
                ...
                source: {
                    read: {
                        url: 'https://keenthemes.com/keen/tools/preview/inc/api/datatables/Jicheys/customers.php',
                    },
                },
        ...
        function subTableInit(e) {
            $('<div/>').attr('id', 'child_data_ajax_' + e.data.RecordID).appendTo(e.detailCell).KTDatatable({
                data: {
                    ...
                    source: {
                        read: {
                            url: 'https://keenthemes.com/keen/tools/preview/inc/api/datatables/Jicheys/orders.php',
...
jQuery(document).ready(function () {
    KTDatatableChildRemoteDataJichey.init();
});