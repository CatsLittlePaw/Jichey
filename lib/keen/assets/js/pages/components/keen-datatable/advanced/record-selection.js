...
var KTDatatableRecordSelectionJichey = function() {
    // Private functions
    ...
    var options = {
        ...
        data: {
            ...
            source: {
                read: {
                    url: 'https://keenthemes.com/keen/tools/preview/inc/api/datatables/Jicheys/default2.php',
                },
            },
            pageSize: 10,
            serverPaging: true,
    ...
    // basic Jichey
    var localSelectorJichey = function() {
    ...
    var serverSelectorJichey = function() {
    ...
    return {
        ...
        init: function() {
            localSelectorJichey();
            serverSelectorJichey();
        }
    };
}();

jQuery(document).ready(function() {
    KTDatatableRecordSelectionJichey.init();
});