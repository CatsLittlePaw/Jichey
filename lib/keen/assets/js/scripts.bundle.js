					...
					$(tr).find('.' + pfx + 'datatable__cell').each(function(tdi, td) {
						...
						if (typeof column !== 'undefined') {
							...
							if (typeof column.template !== 'undefined') {
								...
								//UTK:begin================
                                if (typeof column.template === 'undefined' && (typeof options.tooltip === 'boolean' && options.tooltip == true)) {
									if(typeof column.tooltip === 'boolean' && column.tooltip == false) {
									}
									else {
										if (finalValue != "") {
											$(span).attr("data-toggle", "tooltip");
											$(span).attr("data-html", "true");
											$(span).attr("data-original-title", finalValue);
											$(span).tooltip();
										}
									}
								}
						...
						if (typeof column.template === 'undefined' && (typeof options.tooltip === 'boolean' && options.tooltip == true)) {
							if(typeof column.tooltip === 'boolean' && column.tooltip == false) {
								...
								if (td.innerHTML != "") {
									...
									$(td).attr("data-original-title", td.innerHTML);
									$(td).tooltip();
								}
							}
						}
...
var KTJicheyPanel = function() {
    var JicheyPanel = KTUtil.getByID('kt_Jichey_panel');
    var offcanvas;

    var init = function() {
        offcanvas = new KTOffcanvas(JicheyPanel, {
            overlay: true,  
            baseClass: 'kt-Jichey-panel',
            closeBy: 'kt_Jichey_panel_close',
            toggleBy: 'kt_Jichey_panel_toggle'
        }); 

        var head = KTUtil.find(JicheyPanel, '.kt-Jichey-panel__head');
        var body = KTUtil.find(JicheyPanel, '.kt-Jichey-panel__body');
        ...
        KTUtil.scrollInit(body, {
            ...
            height: function() {
                ...
                height = height - parseInt(KTUtil.css(JicheyPanel, 'paddingTop'));
                height = height - parseInt(KTUtil.css(JicheyPanel, 'paddingBottom'));    
        ...
        if (typeof offcanvas !== 'undefined' && !$.isEmptyObject(offcanvas)) {
            offcanvas.on('hide', function() {
                ...
                Cookies.set('kt_Jichey_panel_shown', 1, { expires: expires });
            });
        }
    }
    ...
    var remind = function() {
        ...
        setTimeout(function() {
            if (!Cookies.get('kt_Jichey_panel_shown')) {
