var Module = function () {
    ...
    var CodeType = "ProductCategory";
    var TextCode = "類別";

    var MethodShowCreate = function () {
        var data = [{ name: TextCode, Mode: 'Append' }];
            ...
            for (var i = 0; i < Cobj.length; i++) {
                ...
                var strtemp = '<tr>\
                                   ...
                                   <td style="text-align:center">\
                                       <button type="button" type="button" class="btn btn-sm btn-clean btn-icon btn-icon-sm Edit" data-id="' + CCobj.sys_id + '"><i class="fas fa-pen"></i></button>\
                                       <button type="button" type="button" class="btn btn-sm btn-clean btn-icon btn-icon-sm Delete" data-id="' + CCobj.sys_id + '"><i class="fas fa-trash-alt"></i></button>\
                                   </td>\
                               </tr> ';
    ...
    var MethodShowUpdate = function (ID) {
        var data = [{ name: TextCode, Mode: 'Edit' }];
        var TmpTable1 = $.templates("#TmpCodeDef");
        var strtemp = TmpTable1.render(data);
