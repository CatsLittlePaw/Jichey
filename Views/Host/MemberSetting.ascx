<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="MemberSetting.ascx.cs" Inherits="Jichey.Views.Host.MemberSetting" %>

<div class="tab-pane fade" id="memberSetting" role="tabpanel">
    <div class="row">
...
<script src="/Views/Host/MemberSetting.js"></script>