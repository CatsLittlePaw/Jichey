<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PageSetting.ascx.cs" Inherits="Jichey.Views.Host.PageSetting" %>


<div class="tab-pane fade show active" id="pageSetting" role="tabpanel">
    <div class="row">
    ...
    <div class="row form-group">
        ...
        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
            <label class="col-form-label">父親上層</label>
            <select id="SearchParentId" name="ParentId" class="form-control" data-control-selectpicker></select>
        </div>
    </div>
    <hr />
    <div class="row">
...
<script src="/Views/Host/PageSetting.js"></script>
