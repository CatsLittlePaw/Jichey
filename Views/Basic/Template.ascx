<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Template.ascx.cs" Inherits="Jichey.Views.Basic.Template" %>
                ...
                <div class="col-12 form-group">
                    <div class="input-group">
                        ...
                        <span class="input-group-btn">
                            <button type="button" id="btnQuickSearch" class="btn btn-info btn-icon btn-elevate" ><i class="fas fa-search" style="color: #EEE"></i></button>
                        </span>
                    </div>
                </div>
            </div>
...
<script src="/Views/Basic/Template.js"></script>
